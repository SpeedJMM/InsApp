...
public class TicketAdapter extends BaseAdapter {
    ...
    private static final int MAX_IMAGE_SIZE = 5;    //默认显示的图片个数
    ...
    public TicketAdapter(Context context, List<String> images, TicketAdapterListener listener) {
    ...
    public View getView(int i, View view, final ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_grid_ticket, viewGroup, false);
