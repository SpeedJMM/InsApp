...
public class KeepWorkOrderNewActivity extends AppCompatActivity {
    ...
    private String selectedProfession, keepworkworkrecordid;
    ...
    private void initEvents() {
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                String workContent = workcontent.getText().toString();
                if (workContent == null || workContent.equals("")) {
                    Snackbar.make(view, "请填写工作内容", Snackbar.LENGTH_SHORT).show();
                    return;
                }
                String startTime = start.getText().toString();
                String endTime = end.getText().toString();
                if (endTime.equals(startTime)) {
                    Snackbar.make(view, "请选择正确的工作时间", Snackbar.LENGTH_SHORT).show();
                    return;
                }
                if (selectedStaffList.size() == 0) {
                    Snackbar.make(view, "请选择工作人员", Snackbar.LENGTH_SHORT).show();
                    return;
                }
                ...
                bean.setNightkeepworkworkcontent(workContent);
                ...
                String url = UrlConstant.addNightKeepWorkAndStaffAppURL;
                VolleyRequest.RequestPost(url, "addNightKeepWorkAndStaffApp", params, new VolleyInterface(VolleyInterface.mListener, VolleyInterface.errorListener, VolleyInterface.jsonListener) {
                    @Override
    ...
    private void initData() {
        ...
        selectedProfession = professionList.get(0);
        ...
        start.setText(sdfTime.format(new Date()));
        end.setText(sdfTime.format(new Date()));
