...
public class SafetyHazardAnalysisActivity extends AppCompatActivity {
    ...
    private final int SUCCESS_CHOOSE_ANALYSIS = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> analysisDatas = getIntent().getStringArrayListExtra("analysisDatas");
        selectedDataList.clear();
        selectedDataList.addAll(analysisDatas);
        getSafetyHazardAnalysisList();
        //initData();
        initView();
        initEvents();
    }
    ...
    private void initEvents() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                analysisDatas.addAll(selectedDataList);
                intent.putStringArrayListExtra("analysis", analysisDatas);
                setResult(SUCCESS_CHOOSE_ANALYSIS, intent);
                finish();
//                AlertDialog.Builder builder = new AlertDialog.Builder(SafetyHazardAnalysisActivity.this)
//                        .setMessage("是否选择？")
...
//                builder.show();
    ...
    //获取安全危害分析数据
    private void getSafetyHazardAnalysisList() {
        if (treeNodeList.size() == 0) {
            VolleyRequest.RequestGet(UrlConstant.getSecHarmAnalysisAppURL, "getSecHarmAnalysisApp", new VolleyInterface(VolleyInterface.mListener, VolleyInterface.errorListener, VolleyInterface.jsonListener) {
                @Override
