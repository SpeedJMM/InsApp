...
public class NonEqptProblemTaskActivity extends AppCompatActivity {
    /**
     * wtdd:问题地点
     * wtms:问题描述
     * gzclcs:故障处理措施
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(view.getContext(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                        ...
                        new TimePickerDialog(NonEqptProblemTaskActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                parameter.setNoneqptrepairtaskcompletsituationid(noneqptRepairTaskProblemBean.getNoneqptrepairtaskcompletsituationid());
                parameter.setNoneqptrepaircompletorderid(noneqptRepairTaskProblemBean.getNoneqptrepaircompletorderid());
                parameter.setNoneqptrepairtaskid(noneqptRepairTaskProblemBean.getNoneqptrepairtaskid());
                ...
                json.setNoneqptrepairdispaorderid(noneqptRepairTaskProblemBean.getNoneqptrepairdispaorderid());
                json.setNoneqptproblemid(noneqptRepairTaskProblemBean.getNoneqptproblemid());
                json.setNoneqptproblemdesc(noneqptRepairTaskProblemBean.getNoneqptproblemdesc());
                json.setNoneqptrepairtaskstarttime(sTime.getText().toString());
                json.setNoneqptrepairtaskendtime(endTime);
                json.setNoneqptrepairtaskcompletsituationremark(remark.getText().toString());
    ...
    private void getMeasureData() {
        ...
        VolleyRequest.RequestGet(url, "getFaulttreatmentmeasApp", new VolleyInterface(VolleyInterface.mListener, VolleyInterface.errorListener, VolleyInterface.jsonListener) {
            ...
            public void onSuccess(String result) {
                ...
                String faulttreatmentmeascode = noneqptRepairTaskProblemBean.getFaulttreatmentmeascode();
    ...
    private void initData () {
        wtdd.setText(noneqptRepairTaskProblemBean.getNoneqptproblemplace());
        wtms.setText(noneqptRepairTaskProblemBean.getNoneqptproblemdesc());
        if (noneqptRepairTaskProblemBean.getNoneqptrepairtaskstarttime() != null) {
            sTime.setText(noneqptRepairTaskProblemBean.getNoneqptrepairtaskstarttime());
        } else {
            sTime.setText(dispaordersecdispatime);
        }
        if (noneqptRepairTaskProblemBean.getNoneqptrepairtaskendtime() != null) {
            eTime.setText(noneqptRepairTaskProblemBean.getNoneqptrepairtaskendtime());
        } else {
            eTime.setText(uploadStandard.format(new Date()));
        }

        if (noneqptRepairTaskProblemBean.getProblemwhetheralreadysol() != null) {
            if (noneqptRepairTaskProblemBean.getProblemwhetheralreadysol()) {
        ...
        String sRemark = noneqptRepairTaskProblemBean.getNoneqptrepairtaskcompletsituationremark();
