...
public class SafetyMeasureActivity extends AppCompatActivity {
    ...
    private final int SUCCESS_CHOOSE_MEASURE = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> measureDatas = getIntent().getStringArrayListExtra("measureDatas");
        selectedDataList.clear();
        selectedDataList.addAll(measureDatas);
    ...
    private void initEvents() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putStringArrayListExtra("measure", selectedDatas);
                setResult(SUCCESS_CHOOSE_MEASURE, intent);
                finish();
//                AlertDialog.Builder builder = new AlertDialog.Builder(SafetyMeasureActivity.this)
//                        .setMessage("是否选择？")
...
//                builder.show();
    ...
    //获取安全措施数据
    private void getSafetyMeasureList() {
        if (treeNodeList.size() == 0) {
            VolleyRequest.RequestGet(UrlConstant.getSecMeasAppURL, "getSecMeasApp", new VolleyInterface(VolleyInterface.mListener, VolleyInterface.errorListener, VolleyInterface.jsonListener) {
                @Override
