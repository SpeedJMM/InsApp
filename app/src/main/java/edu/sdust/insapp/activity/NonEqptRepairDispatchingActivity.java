...
public class NonEqptRepairDispatchingActivity extends AppCompatActivity {
    ...
    private String noneqptrepairdispaorderid;
    ...
    private void initControllers() {
        //标题
        title = findViewById(R.id.tv_nerd_title);
        //调度派工时间
        dispatchtime = findViewById(R.id.tv_nerd_dispatchtime);
        //派工单状态
        orderstatus = findViewById(R.id.tv_nerd_orderstatus);
        //派工单备注
        remark = findViewById(R.id.et_nerd_remark);
        //选择人员
        staff = findViewById(R.id.tv_nerd_staff);
        //人员
        list_staff = findViewById(R.id.list_nerd_staff);
        //选择安全危害分析
        analysis = findViewById(R.id.tv_nerd_analysis);
        //安全危害分析
        list_analysis = findViewById(R.id.list_nerd_analysis);
        //选择安全措施
        measure = findViewById(R.id.tv_nerd_measure);
        //安全措施
        list_measure = findViewById(R.id.list_nerd_measure);
        //派工
        submit = findViewById(R.id.btn_nerd_submit);
        //取消
        cancel = findViewById(R.id.btn_nerd_cancel);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_eqpt_repair_dispatching);
    ...
    private void initEvents() {
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                secDisOrderJson.setNoneqptrepairdispaorderid(Integer.valueOf(noneqptrepairdispaorderid));
                secDisOrderJson.setChangeTask(1);
                Gson gson = new Gson();
                final Map<String, String> params = new HashMap<>();
                params.put("params", gson.toJson(secDisOrderJson));
                AlertDialog.Builder builder = new AlertDialog.Builder(NonEqptRepairDispatchingActivity.this);
