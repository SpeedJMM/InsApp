 ...
 * 滑动查看图片的基类Activity
 */
public class ImagePagerActivity extends ImagePickerBaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private TextView mTextViewCheckBox;
     ...
     */
    public static void start(Activity activity, int startPosition, ImagePickerOptions options, int requestCode) {
...
//        mDataList = intent.getParcelableArrayListExtra(ImageContants.INTENT_KEY_DATA);
        mDataList = DataManager.getInstance().getResultList();
    ...
    protected void onResume() {
        super.onResume();
        if (ImageDataActivity.isYuanTu) {
            mCheckBoxDetail.setChecked(true);
        } else {
            mCheckBoxDetail.setChecked(false);
        }
    }
    ...
    protected void initUI(View contentView) {
        ...
        mCheckBoxDetail = (CheckBox) findViewById(R.id.checkbox_detail);
        mCheckBoxDetail.setChecked(ImageDataActivity.isYuanTu);
        mCheckBoxDetail.setOnCheckedChangeListener(this);
        mTextViewCheckBox = (TextView) findViewById(R.id.tv_checkbox_detail);
        mTextViewCheckBox.setOnClickListener(this);
    ...
    protected void onClick(View v, int id) {
        if (id == R.id.tv_imagepicker_actionbar_preview) {
            ...
            setResult(RESULT_OK);
            finish();
        } else if (id == R.id.tv_checkbox_detail) {
            mCheckBoxDetail.setChecked(!mCheckBoxDetail.isChecked());
        }
    }
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ImageDataActivity.isYuanTu = isChecked;
    }
}
